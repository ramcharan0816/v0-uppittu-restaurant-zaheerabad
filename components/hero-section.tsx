...
export function HeroSection() {
  ...
  return (
    <section
      className="relative py-16 md:py-[72px] px-[6%] bg-cover bg-center bg-no-repeat"
      id="home"
      style={{ backgroundImage: "url('/hero-bg.jpg')" }}
    >
      <div className="absolute inset-0 bg-black/60" />

      <div className="relative z-10 max-w-[1140px] mx-auto grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-7 lg:gap-14 items-center">
        <div>
          ...
          <div className="inline-flex items-center gap-1.5 text-[13px] text-white/70 mb-7">
          ...
          <div className="flex gap-3 flex-wrap">
            ...
            <Button
              ...
              variant="outline"
              className="border-white text-white hover:bg-white/10 px-6 py-3 rounded-[10px] text-[15px] font-medium h-auto bg-transparent"
            >
              Visit Us
            </Button>
          </div>
